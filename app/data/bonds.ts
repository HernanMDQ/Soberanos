export type BondId = 'AO27' | 'AO28' | 'AO29' | 'AN29' | 'AL29' | 'AL30' | 'AL35' | 'AE38' | 'AL41'
...
export const BONDS: Bond[] = [
  ...
  },
  {
    ...
    coupons: [
      ...
      { date: '2028-08-31', rate: 0.50, interest: 0.50, amort: 0 },
      { date: '2028-09-29', rate: 0.48, interest: 0.48, amort: 0 },
      { date: '2028-10-31', rate: 0.53, interest: 0.53, amort: 0 },
      { date: '2028-11-30', rate: 0.52, interest: 0.52, amort: 0 },
      { date: '2028-12-29', rate: 0.50, interest: 0.50, amort: 0 },
      { date: '2029-01-31', rate: 0.50, interest: 0.50, amort: 0 },
      { date: '2029-02-28', rate: 0.48, interest: 0.48, amort: 0 },
      { date: '2029-03-30', rate: 0.50, interest: 0.50, amort: 0 },
      { date: '2029-04-30', rate: 0.47, interest: 0.47, amort: 0 },
      { date: '2029-05-31', rate: 0.55, interest: 0.55, amort: 0 },
      { date: '2029-06-29', rate: 0.50, interest: 0.50, amort: 0 },
      { date: '2029-07-31', rate: 0.50, interest: 0.50, amort: 0 },
      { date: '2029-08-31', rate: 0.50, interest: 0.50, amort: 0 },
      { date: '2029-09-28', rate: 0.48, interest: 0.48, amort: 0 },
      { date: '2029-10-31', rate: 100.53, interest: 0.53, amort: 100 },
    ],
  },
  {
    id: 'AN29',
